<template lang="pug">
.content
	PageHeader(:label="$t('headers.sidebar')")
...
import content_en from "@/assets/docs/components/layout/sidebar/en.md";
import content_zh from "@/assets/docs/components/layout/sidebar/zh.md";
